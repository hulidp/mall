...
import { cachedApiRequest, clearApiCacheByPrefix, getApiCache } from '../utils/apiCache'
...
export const configAPI = {
    get: (options: { force?: boolean } = {}) =>
        cachedApiRequest('config:public', 30_000, () => api.get('/public/config'), options),
    getCached: () => getApiCache<any>('config:public'),
    invalidateCache: () => clearApiCacheByPrefix('config:public'),
}
